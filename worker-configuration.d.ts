/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6e3177e251775a6f6f98b5659604e89f)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BUCKET: R2Bucket;
	WEBDAV_USERNAME: string;
	WEBDAV_PASSWORD: string;
	METADATA: DurableObjectNamespace<import("./src/index").WebDavMetadata>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WebDavMetadata";
	}
